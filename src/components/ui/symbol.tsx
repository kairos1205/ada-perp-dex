      ...
      <td className="">
        <div className="flex flex-row gap-2 items-center">
          ...
          <div className="flex flex-col items-center gap-0">
            ...
            <span className="text-[13px] font-semibold">{Math.floor(value["24h_volume"])}</span>
          </div>
        </div>
      </td>
      <td className="">
        <div className="text-[15px] font-semibold flex justify-end">
          <span className="px-2">{value.mark_price}</span>
